...
const entourage = [
  {
    title: "Men of Honor",
    names: ["Mr. Vince Edward L. Pintac", "Riel Alphonsus C. Malibiran"],
  },
  {
    title: "Groomsmen",
    names: [
      "Carl David B. Aligaya",
      "Ryan Vincent L. Ancajas",
      "Justin V. Cadavillo",
      "Earle M. Calantuan",
      "Aaron O. Estinar",
      "Christopher Jorge P. Francisco",
      "Gem Jahn B. Herrera",
      "Lanz P. Naguit",
      "Mateo E. Siron",
      "Miguel Iñigo S. Vargas",
    ],
  },
  {
  ...
  },
  {
    ...
    names: [
      "Fatima L. Almirañez",
      "Angellie Thea C. Carreon",
      "Kaizen Joy M. Cariaga",
      "Marra D. Clara",
      "Novie Laurice T. Gonzales",
      "Rei Jezreel N. Lavarias",
      "Ivy Marien C. Magpantay",
      "Patrisha Rae M. Pascual",
      "Trisha Mhay C. Romasanta",
      "Hannah Whraxelle D. Tandoc",
    ],
  },
];
...
const symbols = {
  ...
  faith: "John Zachary S. Manahan",
  treasure: "M Cline O. Sepillo",
  commitment: "KL Brent O. Sepillo",
